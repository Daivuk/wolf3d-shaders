...
struct ws_Matrix
{
    ...
    ws_Matrix(float m00, float m01, float m02, float m03,
    ...
    explicit ws_Matrix(const ws_Vector3& r0, const ws_Vector3& r1, const ws_Vector3& r2);
    explicit ws_Matrix(const ws_Vector4& r0, const ws_Vector4& r1, const ws_Vector4& r2, const ws_Vector4& r3);
    explicit ws_Matrix(const float *pArray)
    ...
    bool operator == (const ws_Matrix& M) const
    {
        return
    ...
    ws_Matrix& operator= (const ws_Matrix& M) { memcpy(this, &M, sizeof(float) * 16); return *this; }
    ws_Matrix& operator+= (const ws_Matrix& M)
    {
        _11 += M._11;
        _12 += M._12;
        _13 += M._13;
    ...
    // Urnary operators
    ws_Matrix operator+ () const { return *this; }
    ws_Matrix operator- () const
    {
        return ws_Matrix(
            -_11, -_12, -_13, -_14,
            -_21, -_22, -_23, -_24,
    ...
    // Properties
    ws_Vector3 Up() const;
    void Up(const ws_Vector3& v);

    ws_Vector3 Down() const;
    void Down(const ws_Vector3& v);

    ws_Vector3 Right() const;
    void Right(const ws_Vector3& v);

    ws_Vector3 Left() const;
    void Left(const ws_Vector3& v);

    ws_Vector3 Forward() const;
    void Forward(const ws_Vector3& v);

    ws_Vector3 Backward() const;
    void Backward(const ws_Vector3& v);

    ws_Vector3 AxisY() const;
    void AxisY(const ws_Vector3& v);

    ws_Vector3 AxisX() const;
    void AxisX(const ws_Vector3& v);

    ws_Vector3 AxisZ() const;
    void AxisZ(const ws_Vector3& v);

    ws_Vector3 Translation() const;
    void Translation(const ws_Vector3& v);

    // ws_Matrix operations
    ws_Matrix Transpose() const
    {
        ws_Matrix result;
        result._11 = _11;
        result._12 = _21;
    ...
    void Transpose(ws_Matrix& result) const
    {
        result._11 = _11;
        result._12 = _21;
        result._13 = _31;
    ...
    void Invert(ws_Matrix& result) const
    {
        result = Invert();
    }
    ...
    // Static functions
    static ws_Matrix CreateBillboard(const ws_Vector3& object, const ws_Vector3& cameraPosition, const ws_Vector3& cameraUp, const ws_Vector3* cameraForward = nullptr);
    static ws_Matrix CreateConstrainedBillboard(const ws_Vector3& object, const ws_Vector3& cameraPosition, const ws_Vector3& rotateAxis, const ws_Vector3* cameraForward = nullptr, const ws_Vector3* objectForward = nullptr);
    static ws_Matrix CreateTranslation(const ws_Vector3& position);
    static ws_Matrix CreateTranslation(float x, float y, float z)
    {
        return ws_Matrix(
            1, 0, 0, 0,
            0, 1, 0, 0,
    ...
    static ws_Matrix CreateScale(const ws_Vector3& scales);
    static ws_Matrix CreateScale(float xs, float ys, float zs)
    {
        return ws_Matrix(
            xs, 0, 0, 0,
            0, ys, 0, 0,
    ...
    static ws_Matrix CreateScale(float scale)
    {
        return ws_Matrix(
            scale, 0, 0, 0,
            0, scale, 0, 0,
    ...
    static ws_Matrix Create2DTranslationZoom(const ws_Vector2& resolution, const ws_Vector2& camera, float zoom = 1.0f);

    static ws_Matrix CreateRotationX(float radians)
    {
    ...
    static ws_Matrix CreateRotationY(float radians)
    {
        auto sinTheta = std::sin(radians);
        auto cosTheta = std::cos(radians);
        return ws_Matrix(
    ...
    static ws_Matrix CreateRotationZ(float radians)
    {
        auto sinTheta = std::sin(radians);
        auto cosTheta = std::cos(radians);
        return ws_Matrix(
    ...
    static ws_Matrix CreateFromAxisAngle(const ws_Vector3& axis, float angle);

    static ws_Matrix CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane)
    {
    ...
    static ws_Matrix CreatePerspective(float width, float height, float nearPlane, float farPlane)
    {
    ...
    static ws_Matrix CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane)
    {
        float TwoNearZ = nearPlane + nearPlane;
    ...
    static ws_Matrix CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane)
    {
    ...
    static ws_Matrix CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane)
    {
        float ReciprocalWidth = 1.0f / (right - left);
        float ReciprocalHeight = 1.0f / (top - bottom);
        float fRange = 1.0f / (zNearPlane - zFarPlane);
    ...
    static ws_Matrix CreateLookAt(const ws_Vector3& position, const ws_Vector3& target, const ws_Vector3& up);
    static ws_Matrix CreateWorld(const ws_Vector3& position, const ws_Vector3& forward, const ws_Vector3& up);

    static ws_Matrix CreateFromYawPitchRoll(float yaw, float pitch, float roll)
    {
    ...
    static void Lerp(const ws_Matrix& M1, const ws_Matrix& M2, float t, ws_Matrix& result)
    {
    ...
    static ws_Matrix Lerp(const ws_Matrix& M1, const ws_Matrix& M2, float t)
    {
        return ws_Matrix(
    ...
    // Constants
    static const ws_Matrix Identity;
};

// Binary operators
inline ws_Matrix operator+ (const ws_Matrix& M1, const ws_Matrix& M2)
{
    return ws_Matrix(
        M1._11 + M2._11,
        M1._12 + M2._12,
...
inline ws_Matrix operator* (const ws_Matrix& M, float S)
{
    return ws_Matrix(
        M._11 * S,
        M._12 * S,
...
inline ws_Matrix operator* (float S, const ws_Matrix& M)
{
    return ws_Matrix(
        M._11 * S,
        M._12 * S,
