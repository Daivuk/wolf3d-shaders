...
## How to build
### Prerequisites
- A C++ compiler that supports C++14 or more
- CMake

### Build steps
```
git clone https://github.com/Daivuk/wolf3d-shaders.git
cd wolf3d-shaders
...
```
#### Windows
Open `build/Wolf3DShaders.sln` and enjoy.

## Code structure
Original modified source is in `src/wolfenstein_3d/`. The new code for this project is in `src/wolf3d_shaders/` and everything is pretty much just shove into `ws_main.cpp`.

## Tested on
- Windows 10
- Mac OSX

I did not try Linux, but I bet it works like a charm.

## References
Lot of solutions to early problems has been found on this other SDL port: https://github.com/mozzwald/wolf4sdl
The Math classes are taken from the opensource engine onut: https://github.com/Daivuk/onut
...
* tinyfiledialogs
* dirent
* imgui (Not there yet, but I know it will be in the future)
